...
func dummyResponseMetadata() metadata.MD {
	md := map[string]string{
		...
		"grpc-server-location": "Tokyo, Japan",
...
func (a *GrpcAdaptor) UnaryResiliencyWithMetadata(ctx context.Context, req *resl.ResiliencyRequest) (
...
func (a *GrpcAdaptor) ServerStreamingResiliencyWithMetadata(req *resl.ResiliencyRequest,
...
func (a *GrpcAdaptor) ClientStreamingResiliencyWithMetadata(
...
func (a *GrpcAdaptor) BiDirectionalResiliencyWithMetadata(
